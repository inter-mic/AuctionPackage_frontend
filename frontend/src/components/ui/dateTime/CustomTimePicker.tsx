...
export const CustomTimePicker: React.FC<CustomTimePickerProps> = ({name, selectedTime, onTimeChange, error }) => {
  const [time, setTime] = useState<dayjs.Dayjs | null>(selectedTime ? dayjs(selectedTime).tz('Asia/Tokyo') : null);
