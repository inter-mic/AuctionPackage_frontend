...
export const MailTemplateRegistButton: React.FC<RegistButtonProps> = ({ templateId, templateName, subject, bodyPart2, bodyPart4, body }) => {
    ...
    return (
        <button onClick={handleClick} className="bg-yellow-500 hover:bg-opacity-50 text-white font-bold py-2 px-4 rounded-lg  w-full sm:w-20" >
