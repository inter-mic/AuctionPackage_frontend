              ...
              <tbody>
                {bidHistory.map((bid, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    <td className="border border-gray-300 px-4 py-2">{bid.userName}</td>
                    <td className="border border-gray-300 px-4 py-2">{bid.companyName || "-"}</td>
                    <td className="border border-gray-300 px-4 py-2 text-right">{bid.bidPrice}</td>
                    <td className="border border-gray-300 px-4 py-2 text-center">{bid.bidTime}</td>
                  </tr>
                ))}
              </tbody>
            </table>
