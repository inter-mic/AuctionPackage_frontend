...
export const MemberFormFields: React.FC<Props> = ({ member, handleChange, errors, setErrors }) => {
  ...
  const handleMobileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    handleChange({ target: { name: 'mobile', value: `${mobile1}-${mobile2}-${mobile3}` } } as React.ChangeEvent<HTMLInputElement>);
  };
    ...
    <>
      ...
      <div>
        ...
        <input
          ...
          className={`${styles.commonInput} ${styles.input50}`}
        />
        {errors?.companyUrl && <p className={`error-message ${styles.input50}`}>{errors.companyUrl}</p>}
      </div>
      <div>
        <div className="flex items-center">
          <RequiredMark />
      ...
      <div>
        <label className="formlabel">
          {texts.member.zipCode}{texts.label.hankakuInput}
        </label>
      ...
      <div>
        ...
        <input
          ...
          className={`${styles.commonInput} ${styles.input100}`}
        />
        {errors?.address1 && <p className={`error-message ${styles.input100}`}>{errors.address1}</p>}
      </div>
      <div>
        ...
        <input
          ...
          className={`${styles.commonInput} ${styles.input100}`}
        />
        {errors?.address2 && <p className={`error-message ${styles.input100}`}>{errors.address2}</p>}
      </div>
      <div>
        <label htmlFor="tel" className="formlabel">
          {texts.member.tel}{texts.label.hankakuInput}
        </label>
        <div className="flex items-center space-x-2 lg:w-6/12 sm:w-full">
          <input
            id="tel1"
      ...
      <div>
        <label className="formlabel">
          {texts.member.fax}{texts.label.hankakuInput}
        </label>
        <div className="flex items-center space-x-2 lg:w-6/12 sm:w-full">
          <input
            id="fax1"
      ...
      <div>
        <label className="formlabel">
          {texts.member.mobile}{texts.label.hankakuInput}
        </label>
        <div className="flex items-center space-x-2 lg:w-6/12 sm:w-full">
          <input
            id="mobile1"
