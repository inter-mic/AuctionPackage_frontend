...
//型定義
import { TAdminPaddleSelect, TAdminPaddleRegistRequest, TAdminNextPaddleSearchRequest, initialTAdminPaddleRegistRequest, TAdminPaddleShoninRequest, initialTAdminPaddleShoninRequest } from '@/types/admin/paddle/management';
                ...
                <AccordionDetails  sx={{ backgroundColor: '#f0f0f0' }} >
                    <div className={formSearchStyles.formContainer}>
                        ...
                        <div className={`${formSearchStyles.formGrid} !mt-2`}>
                            ...
                            <div className={formSearchStyles.formItem}>
                                <label htmlFor="paddleKbn"><RequiredMark />{texts.paddle.paddleKbn}</label>
                                <PaddleKbnPullDown
