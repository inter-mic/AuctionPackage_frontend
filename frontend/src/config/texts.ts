export const texts = {
    ...
    goods:{
      ...
      goodsUpload_note_2:"ZIP形式の画像フォルダを選択してください、その他の形式画像はアップロードできません。",
      goodsUpload_note_3:"ZIPファイルサイズは3.0GB以下にしてください。",
      goodsUpload_note_4:"※登録後、30日以内で登録済みでないフォルダが表示されます。",
      goodsUpload_note_5:"※30日経過して商品に紐づかない画像は削除されます。",
      goodsUpload_note_6:"CSVファイル内のデータは、項目ごとにダブルクォーテーション「””」で囲ってください。",
    ...
    contact:{
      ...
      confirm_complete_note_1:"担当者に送信されました。入力されたメールアドレス宛に受付メールが送信されています。"
    },
    bid:{
      auctionSeq:"開催回",
      bidPrice:"入札額",
    ...
    system:{
      ...
      systemRegist_note_10:"※こちらのリンクからファイルをダウンロードして、アップロードしてください。",

    },
    addInfoItem:{
      item:"項目",
      item_note_1:"項目を削除する時は空で更新してください。",
      item_note_2:"一度設定した項目で会員情報を登録済みの場合、項目変更しても登録済みの内容は残ります。",
      item_note_3:"一度設定した項目で商品情報を登録済みの場合、項目変更しても登録済みの内容は残ります。",
    },
    mail:{
      shomei:"署名",
    ...
    page:{
      ...
      note_3:"※PDFファイル添付すると、自動でURLが発行されます。添付した場合、PDF情報が優先してURL設定されます。",
    ...
    label:{
      ...
      forgotPassword_note_1:"パスワードを再設定するためのメールを送信しますので、お客様のメールアドレスをご記入ください。",
      forgotPassword_note_2:"登録されてないメールアドレスを入力された場合は、メール送信されません。",
      registPassword_note_1:"数字、記号、アルファベットを含めた8文字以上を半角文字で入力してください。",
