...
export type TAdminAuctionRegistRequest = {
...
export const initialAuctionData: TAdminAuctionRegistRequest = {
  auctionSeq: null,
  spnKbn: null,
  auctionDate: null,
...
export const formatAuctionData = (
  data: Partial<TAdminAuctionRegistRequest>
  ...
  return {
    ...
    onlinebidApplicationStartDate: data.onlinebidApplicationStarttime
      ? dayjs(data.onlinebidApplicationStarttime)
      : null,
    onlinebidApplicationStarttime: data.onlinebidApplicationStarttime ?? null,
    onlinebidApplicationEndDate: data.onlinebidApplicationEndtime
      ? dayjs(data.onlinebidApplicationEndtime)
      : null,
