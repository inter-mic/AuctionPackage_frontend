...
const Page: React.FC<TPageProps> = () => {  
  ...
  const {  oldPassword, newPassword,newPasswordConfirm,handleOldPasswordChange, handleNewPasswordChange,handleNewPasswordConfirmChange, handleSubmit, errors,responseData } = useLoginCertificationAPI(paramsToken);
      ...
      <div className={styles.page}>
        <div className={styles.container}>
          <form onSubmit={(e) => handleSubmit(e, false)}> 
            ...
            <label htmlFor="oldPassword" className="formLabel mt-3">{texts.loginCertification.oldPassword}</label>
            ...
            <label htmlFor="newPassord" className="formLabel mt-3">{texts.login.newPassword}</label>
            <div className={styles.passwordWrapper}>
            <input
            ...
            > {showNewPassword ? <VisibilityIcon /> : <VisibilityOffIcon />}
             ...
             {formErrors?.newPassword && <p className="error-message">{formErrors.newPassword}</p>}<br />
             <label className="text-gray-500 text-sm">
              {texts.label.registPassword_note_1}<br />
            </label>
             <label htmlFor="newPassordConfirm" className="formLabel mt-3">{texts.login.newPasswordConfirm}</label>
             <div className={styles.passwordWrapper}>
            <input
