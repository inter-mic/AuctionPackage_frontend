            ...
            <div className={styles.leftSection}>
              {isMobile ? (
                ...
                showVideo ? (
                  fetchSystemSettingData?.youtubeIframe && (
                    <div
                      dangerouslySetInnerHTML={{ __html: fetchSystemSettingData.youtubeIframe }}
                      style={{ margin: '0 auto' }}
                    />
                  )
                ) : (
              ...
              <div className={styles.lot}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                  {showVideo ? (
                    <VideocamOffIcon style={{ cursor: 'pointer' }} fontSize="large" onClick={toggleVideo} />
                  ) : (
                    <VideocamIcon style={{ cursor: 'pointer' }} fontSize="large" onClick={toggleVideo} />
                  )}
                </div>
              </div>
