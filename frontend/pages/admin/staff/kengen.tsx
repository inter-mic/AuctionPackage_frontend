          ...
          <div className="flex flex-col items-center justify-center my-3 bg-gray-100">
            <div className="w-full space-y-3 bg-white shadow-md md:max-w-full md:rounded">
              <div className="p-4 xl:w-1/5 sm:w-full">
                <label className={styles.label}><RequiredMark />{texts.kengen.kengenName}</label>
                <input
                  id="kengenName"
                  name="kengenName"
                  type="text"
              ...
              <div className="p-4">
                ...
                {executionPermission(403, 2) && (
                  <Box className="p-4 gap-4 flex flex-col xl:flex-row xl:float-right" display="flex" alignItems="right">
