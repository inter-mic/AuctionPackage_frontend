...
const Page: React.FC<PageProps> = ({ kengen }) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      if (data.spnKbn) {
        setSelectedSpnKbn(data.spnKbn.toString());
      }
    }
  }, [data]);
  ...
  const handleSubmit = () => {
    ...
    const onlinebidApplicationStarttime = CombineDateTime(
      fetchedData.onlinebidApplicationStartDate,
      fetchedData.onlinebidApplicationStarttime
    );
    const onlinebidApplicationEndtime = CombineDateTime(
        ...
        <div className="w-full p-8 space-y-6 bg-white shadow-md md:max-w-full md:rounded">
          <div className="flex">
            <div className="xl:w-1/5 sm:w-full">
              <label htmlFor="spnKbn" className={styles.label}>
                <RequiredMark />
                {texts.auction.spnKbn}
              </label>
              <SpnKbnPullDown
          ...
          {selectedSpnKbn === "1" && (
            <div className="flex">
              <div className="w-full xl:w-1/2">
                <label className={styles.label}>
                  <RequiredMark />
                  {texts.auction.onlinebidApplicationKikan}
                </label>
                <div className="w-full mt-1">
                  <div className="lg:flex">
                    <CustomDatePicker
                ...
                {(formErrors?.onlinebidApplicationStarttime ||
                  formErrors?.onlinebidApplicationEndtime) && (
                  <p className="error-message">
                    {formErrors?.onlinebidApplicationStarttime ||
                      formErrors?.onlinebidApplicationEndtime}
                  </p>
          ...
          <div>
            ...
            {formErrors?.paymentDeadlineDate && (
              <p className="error-message">{formErrors?.paymentDeadlineDate}</p>
            )}
          </div>
          <div>
            <label htmlFor="auctionGaiyo" className={styles.label}>
              {texts.auction.auctionGaiyo}
              <br />
          ...
          <div>
            ...
            />
            <span>{texts.auction.auctionImage_note_1}</span>
            <br />
            ...
            {fetchedData.auctionImageUrl && (
              <>
                ...
                <FormControlLabel
                  control={
                    <Checkbox name="auctionImageIsDelete" onChange={handleDeleteCheckboxChange} />
                  }
          ...
          <div>
            ...
            <FileUpload onFileChange={handleListFileChange} allowedExtensions={["pdf", "xlsx"]} />
            <span>{texts.auction.goodsListUrl_note_1}</span>
            <br />
              ...
              <>
                <div>
                  <Link
                    ...
                    href={fetchedData.auctionListUrl}
                    target="_blank"
                  >
                    {texts.auction.goodsListUrl}
                  </Link>
                ...
                <div>
                  <FormControlLabel
                    control={
                      <Checkbox name="auctionListIsDelete" onChange={handleDeleteCheckboxChange} />
                    }
                    className={styles.label}
                    label={<span>{texts.button.delete}</span>}
                  />
            ...
            <>
              ...
              <div className="sm:flex sm:justify-between sm:items-center">
                <label className="text-gray-500 text-sm">
                  {texts.auction.shime_note_1}
                  <br />
                </label>
                {fetchedData.shimeTime == null ? (
                  <ShimeOnButton auctionSeq={fetchedData.auctionSeq} onUpdate={updateShimeFlg} />
                ) : (
                  <ShimeOffButton auctionSeq={fetchedData.auctionSeq} onUpdate={updateShimeFlg} />
                )}
              </div>
              <div className="divide-y border-gray-500"></div>
