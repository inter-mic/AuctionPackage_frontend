...
const Page: React.FC<PageProps> = ({ kengen }) => {
  ...
  const [images, setImages] = useState<{ imageSeq: string, isNewFlg: boolean, isDeleteFlg: boolean, topImageUrl: string, linkUrl: string }[]>([]);
  const handleImagesUpdate = (updatedImages: { imageSeq: string, isNewFlg: boolean, isDeleteFlg: boolean, topImageUrl: string, linkUrl: string }[]) => {
      ...
      <div className="flex flex-col items-center justify-center my-3 bg-gray-100">
        <div className="w-full space-y-6 bg-white shadow-md md:max-w-full md:rounded mt-1">
          ...
          <div className="p-4">
            ...
            <span>{texts.goods.image_note_2}</span><br/>
