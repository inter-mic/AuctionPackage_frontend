          ...
          <div className="p-4">
            <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 items-end">
              <div className="w-full md:flex-1">
                ...
                <AllInfoListPullDown onChange={handleInfoSeqChange} className={`w-full px-3 py-2 mt-1 border rounded-md focus:outline-none focus:ring focus:border-blue-300`} />
              </div>
      ...
      <div className="flex flex-col items-center justify-center my-10 bg-gray-100">
        <div className="w-full p-8 space-y-6 bg-white shadow-md md:max-w-full md:rounded">
          ...
          <div className="w-full xl:w-1/2">
              <label className={styles.label}><RequiredMark />{texts.auction.displayKikan}</label>
          ...
          <div>
            <label htmlFor="naiyoUrl" className="block text-sm font-medium text-gray-700">
              {texts.info.naiyoUrl}{texts.info.note_1}
            </label>
            <input
              id="naiyoUrl"
              name="naiyoUrl"
