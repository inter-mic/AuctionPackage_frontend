      ...
      <div>
        ...
        <div className="flex flex-col items-center min-h-screen bg-gray-100">
          <div className="w-full p-8 space-y-6 bg-white shadow-md md:max-w-full md:rounded">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">{texts.member.fax}</label>
              <div className="flex items-center space-x-2 lg:w-6/12 sm:w-full">
                <input
                  id="fax1"
                  name="fax1"
            ...
            <div>
              <label htmlFor="companyUrl" className="block text-sm font-medium text-gray-700">
                {texts.admin.companyUrl}
                {texts.admin.admin_note_2}
              </label>
              <input
                id="companyUrl"
                name="companyUrl"
            ...
            <div>
              <label htmlFor="kobutsuBango" className="block text-sm font-medium text-gray-700">
                {texts.admin.kobutsuBango}
                {texts.admin.admin_note_1}
              </label>
              <input
                id="kobutsuBango"
                name="kobutsuBango"
                ...
                className={`w-full px-3 py-2 mt-1 border  focus:outline-none`}
              />
              {formErrors?.kobutsuBango && (
                <p className="error-message">{formErrors.kobutsuBango}</p>
              )}
            </div>
            <div>
              <label htmlFor="copyRight" className="block text-sm font-medium text-gray-700">
                {texts.admin.copyRight}
                {texts.admin.admin_note_1}
              </label>
              <input
                id="copyRight"
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 mt-1 border  focus:outline-none `}
              />
              {formErrors?.furikomiGinkoName && (
                <p className="error-message">{formErrors.furikomiGinkoName}</p>
              )}
            </div>
            <div>
              <label
                htmlFor="furikomiShitenName"
                className="block text-sm font-medium text-gray-700"
              >
                {texts.admin.furikomiShitenName}
                {texts.admin.admin_note_4}
              </label>
              <input
                ...
                className={`w-full px-3 py-2 mt-1 border  focus:outline-none `}
              />
              {formErrors?.furikomiShitenName && (
                <p className="error-message">{formErrors.furikomiShitenName}</p>
              )}
            </div>
            <div>
              <label
                htmlFor="furikomiKozaShurui"
                className="block text-sm font-medium text-gray-700"
              >
                {texts.admin.furikomiKozaShurui}
                {texts.admin.admin_note_4}
              </label>
              <input
                ...
                className={`w-full px-3 py-2 mt-1 border  focus:outline-none `}
              />
              {formErrors?.furikomiKozaShurui && (
                <p className="error-message">{formErrors.furikomiKozaShurui}</p>
              )}
            </div>
            <div>
              <label htmlFor="furikomiKozaNo" className="block text-sm font-medium text-gray-700">
                {texts.admin.furikomiKozaNo}
                {texts.admin.admin_note_4}
              </label>
              <input
                id="furikomiKozaNo"
