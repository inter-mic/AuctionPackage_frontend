...
const Page: React.FC<PageProps> = () => {
  ...
  const { oldPassword, newPassword, newPasswordConfirm, handleOldPasswordChange, handleNewPasswordChange, handleNewPasswordConfirmChange, handleSubmit, handleInputFocus, errors, responseData } = useReissuePasswordAPI();
      ...
      <div className={styles.page}>
        <div className={styles.container}>
          <form onSubmit={(e) => handleSubmit(e)}> 
            <label htmlFor="oldPassword" className="mr-2">{texts.chanePassword.oldPassword}</label>
          ...
          <label htmlFor="newPassordConfirm" className="mr-2">{texts.login.newPasswordConfirm}</label>
          <div className={styles.passwordWrapper}>
