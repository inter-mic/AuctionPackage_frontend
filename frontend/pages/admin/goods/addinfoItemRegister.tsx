  ...
  return (
    <div>
       <div className={breadcrumbStyles.breadcrumb}>
        <span className={breadcrumbStyles.breadcrumbItem}>{texts.menu.adminGoodsAddinfoItemRegist}</span>
      </div>
                  ...
                  <tr key={seq}>
                    ...
                    <td>
                      {executionPermission(206, 2) ? (
                        <GoodsAddinfoItemRegistButton seq={seq} goodsAddinfo={addinfoItems[`goodsAddinfo_${seq}`] || ''}/>
                      ) : (
                        <></>
                      )}
                    </td>
