          ...
          {privacyPolicyPath != "" && (
            ...
            control={
              ...
              label={
                <span>
                   <RequiredMark />
                  <Link className="text-blue-600 underline" href={privacyPolicyPath} target="_blank">
           ...
           {errors?.privacyPolicyAgreed && <p className="error-message">{errors.privacyPolicyAgreed}</p>}
          {kiyakuPath !=  "" && (
            <>
              <br />
